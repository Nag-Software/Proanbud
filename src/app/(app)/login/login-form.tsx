  ...
  ...props
   ...
   const [email, setEmail] = useState('');
      ...
      const StatusMessageDisplay = () => {
        ...
        return (
          <div className={`border px-4 py-3 rounded-md text-base ${styles[statusType]}`}>
            {statusMessage}
          </div>
        );
      };
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        <CardHeader className="text-center pb-4">
          ...
          <CardDescription>
            Logg inn med Apple eller Google-kontoen din
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <FieldDescription className="px-6 text-center">
        Ved å klikke fortsett, godtar du våre <a href="#">Vilkår for bruk</a> og{" "}
