...
const widthClassPattern = /(^|:)(w-|max-w-)/

function hasCustomWidthClass(className?: string) {
  if (!className) return false
  return className
    .split(/\s+/)
    .filter(Boolean)
    .some((cls) => widthClassPattern.test(cls) || cls.includes("max-w["))
}
...
function SheetContent({
  ...
  const customWidthProvided = hasCustomWidthClass(className)
