      ...
      <div className={cn("flex flex-col gap-6", className)} {...props}>
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="text-xl">{inviteToken ? "Aksepter Invitasjon" : "Velkommen til Spikr"}</CardTitle>
            <CardDescription>
              ...
              <FieldGroup>
                <Field>
                  <Button
                    ...
                    type="button"
                    onClick={() => {
                      console.log('SignupForm: starting Google OAuth via /api/auth/google/start')
