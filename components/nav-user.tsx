...
export function NavUser() {
  ...
  if (isLoading) {
    return (
      <SidebarMenu>
        <SidebarMenuItem>
          <SidebarMenuButton size="lg" className="justify-center text-muted-foreground">
  ...
  return (
    <>
            ...
            <DropdownMenuTrigger asChild>
              ...
              >
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  ...
                  <span className="truncate text-xs text-sidebar-foreground/65">{displayEmail}</span>
                </div>
      ...
      <Drawer direction="right" open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
        <DrawerContent className="flex flex-col w-full max-w-2xl ml-auto">
          <DrawerHeader>
